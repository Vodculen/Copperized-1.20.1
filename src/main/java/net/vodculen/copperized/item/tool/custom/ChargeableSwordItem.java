...
public class ChargeableSwordItem extends SwordItem {
	private int attackDamage;
	private float attackSpeed;
	private final ToolMaterial baseMaterial;
	private final ToolMaterial chargedMaterial;

	public ChargeableSwordItem(ToolMaterial baseMaterial, ToolMaterial chargedMaterial, int attackDamage, float attackSpeed, int chargedTicks, Settings settings) {
