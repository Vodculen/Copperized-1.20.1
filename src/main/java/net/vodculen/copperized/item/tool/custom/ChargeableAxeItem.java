...
public class ChargeableAxeItem extends AxeItem {
	private int attackDamage;
	private float attackSpeed;
	private final ToolMaterial baseMaterial;
	private final ToolMaterial chargedMaterial;

	public ChargeableAxeItem(ToolMaterial baseMaterial, ToolMaterial chargedMaterial, int attackDamage, float attackSpeed, int chargedTicks, Settings settings) {
