...
public class ChargeableShovelItem extends ShovelItem {
	private float attackDamage;
	private float attackSpeed;
	private final ToolMaterial baseMaterial;
	private final ToolMaterial chargedMaterial;

	public ChargeableShovelItem(ToolMaterial baseMaterial, ToolMaterial chargedMaterial, float attackDamage, float attackSpeed, int chargedTicks, Settings settings) {
