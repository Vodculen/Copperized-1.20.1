...
public class ChargeableHoeItem extends HoeItem {
	private int attackDamage;
	private float attackSpeed;
	private final ToolMaterial baseMaterial;
	private final ToolMaterial chargedMaterial;

	public ChargeableHoeItem(ToolMaterial baseMaterial, ToolMaterial chargedMaterial, int attackDamage, float attackSpeed, int chargedTicks, Settings settings) {
